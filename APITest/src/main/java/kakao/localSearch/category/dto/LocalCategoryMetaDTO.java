...
/**
 * <strong>LocalCategoryResponseDTO에 포함되는 클래스</strong> 
 * <pre> 응답받은 문서의 정보가 담김</pre>
 */
public class LocalCategoryMetaDTO {
	/*
	...
	private LocalCategoryMetaSameNameDTO same_name;
	
	/** 기본 생성자 */
	public LocalCategoryMetaDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	/** 전체 멤머 변수 초기화 */
	public LocalCategoryMetaDTO(Integer total_count, Integer pageable_count, boolean is_end,
			LocalCategoryMetaSameNameDTO same_name) {
		super();
	 ...
	 */
	public LocalCategoryMetaSameNameDTO getSame_name() {
		return same_name;
	}
	 ...
	 */
	public void setSame_name(LocalCategoryMetaSameNameDTO same_name) {
		this.same_name = same_name;
	}

	@Override
	public String toString() {
		return "LocalCategoryMetaDTO [total_count=" + total_count + ", pageable_count=" + pageable_count + ", is_end="
