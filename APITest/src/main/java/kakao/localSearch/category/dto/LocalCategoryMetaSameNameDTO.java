...
/**
 * <strong>LocalCategoryMetaDTO에 포함되는 클래스</strong>
 * <pre>질의어에 인식한 결과값과 비슷한 정보들이 담김</pre>
 * @author dongdang
 *
 */
public class LocalCategoryMetaSameNameDTO {
	/*
	...
	/** 전체 멤버 변수 초기화*/
	public LocalCategoryMetaSameNameDTO(List<String> region, String keyword, String selected_region) {
		super();
		this.region = region;
