...
/**
 * <strong>LocalCategoryReponseDTO에 포함되는 클래스</strong>
 * <pre>장소의 정보를 담음</pre>
 * @author dongdang
 *
 */
public class LocalCategoryDocumentDTO {
	/*
	 * 변수 설명
	 * id = 장소 ID
	 * place_name=장소명, 업체명
	...
	/** 기본 생성자 */
	public LocalCategoryDocumentDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	/** 모든 멤버 변수 초기화 */
	public LocalCategoryDocumentDTO(String id, String place_name, String category_name, String category_group_code,
